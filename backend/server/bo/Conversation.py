...
class Conversation (NamedBusinessObject):
    ...
    def str(self):
        ...
        return "Conversation: {}, {}, {}, {}, {}, {}".format(self.get_id(), self.get_creation_time(), self.get_name(), self.get_message(), self.get_participant(), self.get_user_id())
    @staticmethod
    def from_dict(dictionary):
        """Converting a Python dict() to a Conversation() object"""
        obj = Conversation()
